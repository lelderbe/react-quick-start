...
import { Suggest, Rating } from '../../components';
...
export function FormInput({ type = 'input', defaultValue = '', options = [], ...rest }) {
    switch (type) {
        ...
        case 'suggest':
            return <Suggest defaultValue={defaultValue} options={options} {...rest} />;
        case 'rating':
            return <Rating {...rest} defaultValue={defaultValue ? parseInt(defaultValue, 10) : 0} />;
        case 'textarea':
