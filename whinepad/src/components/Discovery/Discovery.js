...
export function Discovery() {
    ...
    return (
        <div className="Discovery">
            ...
            <h2>Header</h2>
            <Header onSearch={(e) => console.log(e)} onAdd={() => alert('add')} count={3} />
            ...
            <p>
                Custom class name: <Button className="Discovery-custom-button">I do nothing</Button>
            </p>
            ...
            <Button
                onClick={() => {
                    const data = {};
                    Array.from(form.current).forEach((input) => (data[input.id] = input.value));
